...
- (void)viewDidLoad {
    ...
    _bannerView = [[GADBannerView alloc] initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, 50)];
    self.bannerView.adUnitID = @"ca-app-pub-6092667862424445/3210615815";
