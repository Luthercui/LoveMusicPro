...
#define MS_paly_Banner @"8/LzIJxkfunADc2pdFHkzn/V"//横幅广告位
#define MS_shezhi_Banner @"8/LzIJxkfunADc2pdFHkzn/V"//横幅广告位
#define MS_Test_SlotToken_Poster @""//全屏广告位
#define MS_Native @"Z2ZntAjw6n1UmVk94FZwWutJ"//开广告位
