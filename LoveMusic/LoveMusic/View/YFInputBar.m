...
{
    if (!_textField) {
        _textField = [[UITextField alloc]initWithFrame:CGRectMake(10, 10, self.frame.size.width-70, 24)];
...
-(UIButton *)sendBtn
{
    if (!_sendBtn) {
        ...
        [_sendBtn setTitle:@"隐藏" forState:UIControlStateNormal];
        [_sendBtn setTitleColor: [UIColor colorWithRed:8.0/255.0 green:129.0/255.0 blue:181.0/255.0 alpha:1.0] forState:UIControlStateNormal];
        [_sendBtn setFrame:CGRectMake(self.frame.size.width-50, 10, 40, 24)];
